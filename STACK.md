...
- Both cloud providers use the same disposition. HTTP 429 and HTTP 500 to 599 use the bounded backoff. Other HTTP failures wait for explicit Retry, a settings change, or an hourly recheck.
